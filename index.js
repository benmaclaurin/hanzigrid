exports.generate = function(rows, columns, options) {
  ...
  if (options != null) {
    ...
    if (options.lines == 2) {
      box += '<line id="Line_1" data-name="Line 1" class="cls-2" y2="335" transform="translate(506.5 201.5)"/> <line id="Line_2" data-name="Line 2" class="cls-2" x2="335" transform="translate(339.5 368.5)"/>';
    } else {
      box += '<line id="Line_2" data-name="Line 2" class="cls-2" x2="335" transform="translate(339.5 368.5)"/> <line id="Line_1" data-name="Line 1" class="cls-2" y2="335" transform="translate(506.5 201.5)"/> <line id="Line_3" data-name="Line 3" class="cls-2" x1="335" y2="335" transform="translate(339.5 201.5)"/> <line id="Line_4" data-name="Line 4" class="cls-2" x2="335" y2="335" transform="translate(339.5 201.5)"/>';
    }
    box += '</g> </svg>';
  } else {
